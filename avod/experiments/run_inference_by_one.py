...
def get_kitti_pred(predictions, idx, dataset, box_rep):
    ...
    corr_offset = pred_frame_0[mask][:, 10:13]
...
with tf.Graph().as_default():
    ...
    sess = create_sesson(model_config, cpkt_idx=120)
    for i in range(200):
        ...
        print(pred_frame_kitti_0.shape, pred_frame_kitti_1.shape, corr_offset.shape)
