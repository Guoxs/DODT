...
def tracking_object_label_to_box_3d(tra_label):
    """Turns an TrackingLabel into an box_3d

    Args:
        obj_label: TrackingLabel

    Returns:
        anchor: 3D box in box_3d format [x, y, z, l, w, h, ry, id]
    """

    fc.check_object_label_format(tra_label)

    box_3d = np.zeros(8)

    box_3d[0:3] = tra_label.t
    box_3d[3] = tra_label.l
    box_3d[4] = tra_label.w
    box_3d[5] = tra_label.h
    box_3d[6] = tra_label.ry
    box_3d[7] = tra_label.object_id
...
def tracking_box_3d_to_anchor(boxes_3d, ortho_rotate=False):
    """ Converts a box_3d [x, y, z, l, w, h, ry, id]
    into anchor form [x, y, z, dim_x, dim_y, dim_z, id]
    ...
    fc.check_tracking_box_3d_format(boxes_3d)
